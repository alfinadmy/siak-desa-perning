    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center"><b>DATA SURAT PERMOHONAN PEMASANGAN LISTRIK BARU</b></h4>
                <hr>
            </div>
            ...
            <div class="box-body table-responsive">
                ...
                <p><a href="<?= base_url('pemasangan_listrik/tambah'); ?>" class="btn btn-primary">Tambah surat Permohonan</a></p>
                ...
                <table id="data" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($pemasangan_listrik as $pl) {
                            ?>
                            <tr>
                                ...
                                <td><?= $pl->nama; ?></td>
                                <td><?= $pl->daya; ?></td>
                                <td><?= $pl->nama_pejabat; ?></td>
                                <td style="text-align:center">
                                    <a href="<?= base_url('pemasangan_listrik/edit/' . $pl->id_pemasangan_listrik); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                    <a href="#" class="btn btn-danger btn-xs" onclick="showDeleteConfirmationModal('<?= base_url('pemasangan_listrik/hapus/' . $pl->id_pemasangan_listrik); ?>')"><i class="fa fa-trash-o"></i>Hapus</a>
                                    <button onclick="printPemasanganListrik('<?= $pl->id_pemasangan_listrik; ?>')" class="btn btn-info btn-xs"><i class="fa fa-print"></i> Cetak</button>
                            </tr>
                            </td>
                            <?php
                                $no++;
...
<script>
    ...
    function printPemasanganListrik(id) {
        // Redirect pengguna ke halaman cetak
        window.open('<?= base_url('pemasangan_listrik/cetak/'); ?>' + id, '_self');
    }

    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body table-responsive">
                ...
                ?>
                <p>
                    <a href="<?= base_url('penghasilan/tambah'); ?>" class="btn btn-primary">Tambah SK Penghasilan</a>
                </p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $ph->nik; ?></td>
                                <td><?= $ph->nama; ?></td>
                                <td><?= $ph->jumlah_penghasilan; ?></td>
                                <td><?= $ph->keperluan_penghasilan; ?></td>
                                <td><?= $ph->nama_pejabat; ?></td>
                                <td style="text-align:center">
                                    <a href="<?= base_url('penghasilan/edit/' . $ph->id_penghasilan); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                    <a href="#" class="btn btn-danger btn-xs" onclick="showDeleteConfirmationModal('<?= base_url('penghasilan/hapus/' . $ph->id_penghasilan); ?>')"><i class="fa fa-trash-o"></i>Hapus</a>
                                    <button onclick="printSktm('<?= $ph->id_penghasilan; ?>')" class="btn btn-info btn-xs"><i class="fa fa-print"></i> Cetak</button>
                            </tr>
                            </td>
                        <?php
                            $no++;
...
<script>
    ...
    function printSktm(id) {
        ...
        window.open('<?= base_url('penghasilan/cetak/'); ?>' + id, '_self');
    }

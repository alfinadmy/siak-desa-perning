    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center"><b>DATA SURAT KETERANGAN TIDAK MAMPU</b></h4>
                <hr>
            </div>
            ...
            <div class="box-body table-responsive">
                ...
                <p>
                    <a href="<?= base_url('sktm/tambah'); ?>" class="btn btn-primary">Tambah SKTM</a>
                </p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="<?= base_url('sktm/edit/' . $surat->id_sktm); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                <a href="#" class="btn btn-danger btn-xs" onclick="showDeleteConfirmationModal('<?= base_url('sktm/hapus/' . $surat->id_sktm); ?>')"><i class="fa fa-trash-o"></i>Hapus</a>
                                <button onclick="printSktm('<?= $surat->id_sktm; ?>')" class="btn btn-info btn-xs"><i class="fa fa-print"></i> Cetak</button>
                        </tr>
                        </td>
                        <?php
                            $no++;
...
<script>
    ...
    function printSktm(id) {
        ...
        window.open('<?= base_url('sktm/cetak/'); ?>' + id, '_self');
    }

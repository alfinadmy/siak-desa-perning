            ...
            <div class="box box-info">
                <div class="box-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                <h4 style="text-align:center"><b>EDIT SURAT KETERANGAN CERAI MATI</b></h4>
                                <hr>
                            </div>

                            <div class="box-body">
                                <form action="<?= base_url('cerai_mati/proses_edit'); ?>" method="post">

                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>NIK dan Nama</label><br>
                                            <input type="hidden" name="id" class="form-control" required value="<?= $cerai_mati->id_cerai_mati; ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?= base_url('cerai_mati/'); ?>" class="btn btn-danger">Batal</a>
                                        </div>
                                    </div>
                                </form>
                            </div>

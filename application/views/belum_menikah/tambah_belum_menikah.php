            ...
            <div class="box box-info">
                <div class="box-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                <h4 style="text-align:center"><b>TAMBAH SURAT BELUM MENIKAH</b></h4>
                                <hr>
                            </div>

                            <div class="box-body">
                                <form action="<?= base_url('belum_menikah/proses_tambah'); ?>" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?= base_url('belum_menikah/'); ?>" class="btn btn-danger">Batal</a>
                                        </div>
                                    </div>
                                </form>
                            </div>

    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center"><b>DATA SURAT KETERANGAN USAHA</b></h4>
                <hr>
            </div>
            ...
            <div class="box-body table-responsive">
                ...
                ?>
                <p>
                    <a href="<?= base_url('usaha/tambah'); ?>" class="btn btn-primary">Tambah SK Usaha</a>
                </p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $ush->sejak_usaha; ?></td>
                                <td><?= $ush->nama_pejabat; ?></td>
                                <td style="text-align:center">
                                    <a href="<?= base_url('usaha/edit/' . $ush->id_usaha); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                    <a href="#" class="btn btn-danger btn-xs" onclick="showDeleteConfirmationModal('<?= base_url('usaha/hapus/' . $ush->id_usaha); ?>')"><i class="fa fa-trash-o"></i>Hapus</a>
                                    <button onclick="printSktm('<?= $ush->id_usaha; ?>')" class="btn btn-info btn-xs"><i class="fa fa-print"></i> Cetak</button>
                        </tr>
                            </td>
                        <?php
                            $no++;
...
<script>
    ...
    function printSktm(id) {
        ...
        window.open('<?= base_url('usaha/cetak/'); ?>' + id, '_self');
    }

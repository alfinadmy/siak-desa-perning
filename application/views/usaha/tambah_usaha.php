            ...
            <div class="box box-info">
                <div class="box-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                <h4 style="text-align:center"><b>TAMBAH SURAT KETERANGAN USAHA</b></h4>
                                <hr>
                            </div>

                            <div class="box-body">
                                <form action="<?= base_url('usaha/proses_tambah'); ?>" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Sejak</label>
                                            <input type="text" name="sejak_usaha" class="form-control" placeholder="Sejak" required />
                                        </div>
                                        <div class="form-group">

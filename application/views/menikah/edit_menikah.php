            ...
            <div class="box box-info">
                <div class="box-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                <h4 style="text-align:center"><b>EDIT SURAT MENIKAH</b></h4>
                                <hr>
                            </div>

                            <div class="box-body">
                                <form action="<?php echo base_url('menikah/proses_edit'); ?>" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="pejabat" class="form-control" required>
                                                ...
                                                foreach ($pejabat as $pejabat) :
                                                    if ($pejabat->id_pejabat == $menikah->id_pejabat) {
                                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo base_url('menikah/'); ?>" class="btn btn-danger">Batal</a>
                                        </div>
                                    </div>
                                </form>
                            </div>

    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center"><b>DATA SURAT KETERANGAN DOMISILI</b></h4>
                <hr>
            </div>
            ...
            <div class="box-body table-responsive">
                ...
                <p>
                    <a href="<?= base_url('domisili/tambah'); ?>" class="btn btn-primary">Tambah SK Domisili</a>
                </p>
                <table id="data" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr class="active">
                            ...
                            <th style="text-align:center">No. Surat Pengantar</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $dom->nik; ?></td>
                                <td><?= $dom->nama; ?></td>
                                <td><?= $dom->no_surat_rt; ?></td>
                                <td><?= $dom->nama_pejabat; ?></td>
                                <td style="text-align:center">
                                    <a href="<?= base_url('domisili/edit/' . $dom->id_domisili); ?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                    <a href="#" class="btn btn-danger btn-xs" onclick="showDeleteConfirmationModal('<?= base_url('domisili/hapus/' . $dom->id_domisili); ?>')"><i class="fa fa-trash-o"></i>Hapus</a>
                                    <button onclick="printSktm('<?= $dom->id_domisili; ?>')" class="btn btn-info btn-xs"><i class="fa fa-print"></i> Cetak</button>
                            </tr>
                            </td>
...
<script>
    ...
    function printSktm(id) {
        ...
        window.open('<?= base_url('domisili/cetak/'); ?>' + id, '_self');
    }
